        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography color="primary" variant="subtitle2" className={classes.subtitle}>Lead Android Developer</Typography>
              <Typography color="primary" variant="subtitle2" align="left">
                <ul>
                  <li>As main Android developer during the app's early stage, established and led the initial Android development efforts, mentoring a team of talented and passionate students dedicated to the continual betterment of the app and positively impacting the HKUST student community</li>
                  <li>Developed and integrated a Convolutional Neural Network (CNN) based CAPTCHA solver (achieving ~98.1% accuracy) and integrated it into the app's facility booking feature to enable faster, more reliable automated bookings</li>
                </ul>
              </Typography>
